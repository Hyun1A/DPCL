...
def base_parser():
    ...
    """ new parameter for hierarchical classification experiment """
    
    # gpu index
    parser.add_argument('--gpu_idx', type=str, default="0", help='# candidates to use for MIR')
    # Debug
    parser.add_argument("--debug", type=int, default=0, help="Turn on Debug mode")  

    parser.add_argument('--temp', type=float, default=0.1, help='temperature')
    
    parser.add_argument('--lamb_u', type=float, default=1.0, help='temperature')
    parser.add_argument('--tau', type=float, default=0.8, help='temperature')
    parser.add_argument('--root', type=str, default=".", help='temperature')
    parser.add_argument('--exp_name', type=str, default="exp_default", help='temperature')
    parser.add_argument('--gamma', type=float, default=1.0, help='regularization by contrastive loss')
    
    """ for noisy feature mixup """
    parser.add_argument('--alpha', type=float, default=1.0, help='for NFM')
    parser.add_argument('--manifold_mixup', type=bool, default=False, help='for NFM')
    parser.add_argument('--add_noise_level', type=float, default=0.4, help='for NFM')
    parser.add_argument('--mult_noise_level', type=float, default=0.2, help='for NFM')
       
    """ for dro """
    parser.add_argument('--method_dro', type=str, default='SVGD', help= 'DRO method: SGLD, SVGD')
    parser.add_argument('--T_adv_dro', type=int, default=5, help='for DRO')
    parser.add_argument('--gamma_dro', type=float, default=0.2, help='for DRO')
    parser.add_argument('--beta_dro', type=float, default=0.02, help='for DRO')
    parser.add_argument('--stepsize_dro', type=float, default=0.0001, help='for DRO')
