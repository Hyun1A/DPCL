...
def get_train_datalist(root, dataset, n_tasks, m, n, rnd_seed, cur_iter: int) -> List:
    ...
    print(f"{root}/collections/{dataset}/{dataset}_split{n_tasks}_n{n}_m{m}_rand{rnd_seed}_task{cur_iter}.json")
    #input()
...
def get_statistics(dataset: str):
    ...
    mean = {
        ...
        "cifar100_sc": (0.5071, 0.4867, 0.4408),
    ...
    std = {
        ...
        "cifar100_sc": (0.2675, 0.2565, 0.2761),
