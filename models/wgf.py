...
# https://github.com/joey-wang123/DRO-Task-free/blob/8f8363a73e8878598e92c70de66f88893c858e42/WGF.py
...
def WGF_retrieve_replay_update(args, model, opt, input_x, input_y, \
                               mem_x, mem_y, loader = None, rehearse=True):
    ...
    total_loss = normal_loss + args.beta_dro*adv_loss
    #total_loss.backward()
